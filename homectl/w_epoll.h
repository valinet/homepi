...
static inline int w_epoll_create(int flags)
{
...
static inline int w_epoll_add_ptr_in(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;

        ev.events = EPOLLIN;
        if (epollet) ev.events |= EPOLLET;
        ev.data.ptr = ptr;

        return epoll_ctl(epollfd, EPOLL_CTL_ADD, fd, &ev);
}

static inline int w_epoll_add_ptr_out(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;
...
static inline int w_epoll_add_ptr_inout(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;
...
static inline int w_epoll_update_ptr_in(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;
...
static inline int w_epoll_update_ptr_out(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;
...
static inline int w_epoll_update_ptr_inout(int epollfd, int fd, void *ptr, int epollet)
{
        struct epoll_event ev;
